...
{
    public class EventTicketsCategories : Page
    {
        #region Constructors
        public EventTicketsCategories()
        { }
        public EventTicketsCategories(IWebDriver driver, TestRunSettings runsettings)
        {
            this.Driver = driver;
        ...
        public override string Path => $"/{RunSettings.Locale}{RunSettings.Catalog_Eventtickets_Categories}{RunSettings.ValidUser.Schema}/34";
        #endregion
        #region Functionality of Test Cases.
        public string CreatingLink(int i)
        {
            string uris = RunSettings.Url + RunSettings.Locale + RunSettings.Catalog_Eventtickets_Categories + RunSettings.ValidUser.Schema + "/" + i;
            return uris;
        }
